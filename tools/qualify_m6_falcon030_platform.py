...
def main():
 ...
 effective={'profile_id':profile['id'],'machine':'falcon','cpu_level':3,'cpu_clock_mhz':16,'st_ram_mib':4,'addressing_bits':32,'mmu':True,'run_vbls':run_vbls,'guest_program':'C:\\AUTO\\M6FAL.PRG','result_file':'C:\\M6FAL.TXT','launch':'gemdos-auto-folder'}
